...
本仓库尚未附带许可证（LICENSE）文件。建议在公开发布前显式选择许可方式——
对于此类研究文本，常见的选择是 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
（署名即可转载）或 [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/)
（署名、非商业、禁止演绎，更契合需要保持文本完整与语境的敏感研究）。
